...
\begin{itemize}
  ...
  \item By December, this could be the empirical base of a full paper
\end{itemize}
...
\begin{itemize}
  ...
  \item Good documentation is not extra work; it is part of the research output
\end{itemize}
\end{column}
\end{columns}
...
\begin{itemize}
  ...
  \item No commands required: \textbf{GitHub Desktop} is a friendly standalone app --- and the \textbf{agent drives Git} happily (``commit this with a sensible message'')
\end{itemize}
