...
\color{white}\footnotesize\ttfamily
analysis\_final.do\\
analysis\_final\_v2.do\\
analysis\_final\_v2\_REAL.do\\
analysis\_final\_v2\_REAL\_use\_this\_one.do
\end{tcolorbox}

\vspace{0.3cm}

\begin{itemize}
  \item We've all been there. Git replaces this with \textbf{one file and a history}
  \item Every commit is a snapshot: what changed, when, and (if you write good messages) why
  \item When an agent is editing your files, that history is your \textbf{audit trail}
\end{itemize}
