...
\begin{tikzpicture}[remember picture, overlay]
  \pgfmathsetseed{4242}%
  \node[anchor=south east, xshift=-1.5cm, yshift=0.85cm,
  ...
  \draw[DeepCharcoal, line width=1.0pt, rounded corners=11pt,
        decorate, decoration={random steps, segment length=8pt, amplitude=2.0pt}]
  ...
  \draw[DeepCharcoal!70, line width=0.6pt, rounded corners=10pt,
        decorate, decoration={random steps, segment length=12pt, amplitude=3.0pt}]
    ($(asidebox.south west)+(-4pt,-1pt)$) rectangle ($(asidebox.north east)+(1.5pt,4pt)$);
  \node[anchor=south west, text=UVMGold, font=\small]
    at ([xshift=3pt, yshift=1pt]asidebox.north west) {\faCommentDots};
\end{tikzpicture}}
