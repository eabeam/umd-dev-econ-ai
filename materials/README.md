...
Cheat sheets and curated links for the semester project. Everything here is yours to copy into your own repo — and see [`templates/`](../templates/README.md) for working versions of the config pattern, cleaning/analysis file skeletons, and the `AGENTS.md` house-rules file the lecture refers to.
